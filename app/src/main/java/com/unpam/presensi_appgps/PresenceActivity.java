...
public class PresenceActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
...
//            String latit = String.format ( "%s",mylati );
//           // String latit1 = latit.;
//            title2.setText (latit);
//            title.setText (latit.length ());
    ...
    public void checkin(View view) {
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST,BASE_URL + "presenceapp_gps/system/checkin.php",
            ...
            public void onResponse(String response) {
                try {
                   ...
                   // Snackbar.make(getView(), message, Snackbar.LENGTH_LONG).show();
                    if (success == 1) {
                        Toast.makeText(PresenceActivity.this, "Success!", Toast.LENGTH_SHORT).show();
                        checkin.setVisibility(View.INVISIBLE);
...
//                        txtCheckOut.setText(statusCheckOut);
    ...
    public void checkout(View view) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, BASE_URL + "presenceapp_gps/system/checkout.php",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(PresenceActivity.this, "Error" + e.toString(), Toast.LENGTH_SHORT).show();
                        }
                ...
                new Response.ErrorListener() {
                    @Override
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(PresenceActivity.this, "Error!" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                })
        {
            @Override
    ...
    public void about(View view) {
        startActivity(new Intent(PresenceActivity.this, AboutActivity.class));
    ...
    public void profil(View view) {
        startActivity(new Intent(PresenceActivity.this, ProfilActivity.class));
    ...
    private boolean checkPlayServices() {
        ...
        if (resultCode != ConnectionResult.SUCCESS) {
            ...
            (GooglePlayServicesUtil.isUserRecoverableError(resultCode)) {
                GooglePlayServicesUtil.getErrorDialog(resultCode,PresenceActivity.this,PLAY_SERVICES_RESOLUTION_REQUEST).show();
            } else {

                Toast.makeText(PresenceActivity.this, "This device is not supported.",
